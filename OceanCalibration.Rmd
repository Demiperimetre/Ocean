...
#                        Sigdisc=homMLEdisc$Sigdisc,priorUpBounds2b=NULL,rep=2,logvar=T
...
#                              Sigdisc=hetMLEdisc$Sigdisc,priorUpBounds2b=NULL,rep=2,logvar=T
#                              ,logfun=TRUE, theta.init=c(0.5,0.5,log(1/Yv),log(1/Yv)),
#                              burnin=nburnin, mcmc=nMCMC,V=Vrw,thin=Thin)
...
#                                 Sigdisc=seqhetMLEdisc$Sigdisc,priorUpBounds2b=NULL,rep=2,logvar=T
#                              ,logfun=TRUE, theta.init=c(0.5,0.5,log(1/Yv),log(1/Yv)),
#                              burnin=nburnin, mcmc=nMCMC,V=Vrw,thin=Thin)
